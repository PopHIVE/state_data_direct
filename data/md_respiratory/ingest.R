# ingest.R - Maryland (MD) Respiratory Surveillance
# Provider: Maryland Department of Health
# Tier 2 | Strategy: chromote
# Run from data/md_respiratory/
...
state_fips  <- "24"
state_name  <- "Maryland"
source_urls <- c("https://health.maryland.gov/phpa/Pages/Respiratory-Virus-Surveillance.aspx", "https://public.tableau.com/views/MarylandCombinedRespiratoryIllness/Dashboard")
...
# Chromote headless browser: Maryland

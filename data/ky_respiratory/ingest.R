# ingest.R - Kentucky (KY) Respiratory Surveillance
# Provider: Kentucky Department for Public Health
# Tier 2 | Strategy: chromote
# Run from data/ky_respiratory/
...
state_fips  <- "21"
state_name  <- "Kentucky"
source_urls <- c("https://dashboard.chfs.ky.gov/views/DPHRSP001RespiratoryDiseases/HospitalizationsandEDVisits", "https://dashboard.chfs.ky.gov/views/DPHRSP001RespiratoryDiseases/DeathsHistorical", "https://dashboard.chfs.ky.gov/views/DPHRSP001RespiratoryDiseases/Influenza-likeIllness", "https://dashboard.chfs.ky.gov/views/DPHRSP001RespiratoryDiseases/LaboratoryReporting")
...
# Chromote headless browser: Kentucky

# ingest.R - Georgia (GA) Respiratory Surveillance
# Provider: Georgia Department of Public Health
# Tier 2 | Strategy: chromote
# Run from data/ga_respiratory/
...
state_fips  <- "13"
state_name  <- "Georgia"
source_urls <- c("https://dph.georgia.gov/epidemiology/acute-disease-epidemiology/viral-respiratory-diseases", "https://wastewatersurveillance.s3.us-east-1.amazonaws.com/ExternalNWSS_20251112.html")
...
# Chromote headless browser: Georgia

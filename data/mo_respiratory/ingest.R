# ingest.R - Missouri (MO) Respiratory Surveillance
# Provider: Missouri Department of Health & Senior Services
# Tier 2 | Strategy: chromote
# Run from data/mo_respiratory/
...
state_fips  <- "29"
state_name  <- "Missouri"
source_urls <- c("https://health.mo.gov/living/healthcondiseases/communicable/influenza/dashboard.php")
...
# Chromote headless browser: Missouri

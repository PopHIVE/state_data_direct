# ingest.R - Indiana (IN) Respiratory Surveillance
# Provider: Indiana Department of Health
# Tier 2 | Strategy: chromote
# Run from data/in_respiratory/
...
state_fips  <- "18"
state_name  <- "Indiana"
source_urls <- c("https://www.in.gov/health/directory/office-of-the-commissioner/public-health-data-navigator/infectious-disease-prevention-and-control/influenza-data-dashboard/", "https://www.in.gov/health/directory/office-of-the-commissioner/public-health-data-navigator/infectious-disease-prevention-and-control/covid-19-trends-and-wastewater-dashboard/")
...
# Chromote headless browser: Indiana

# ingest.R - Massachusetts (MA) Respiratory Surveillance
# Provider: Massachusetts Department of Public Health
# Tier 2 | Strategy: chromote
# Run from data/ma_respiratory/
...
source_urls <- c("https://www.mass.gov/info-details/respiratory-illness-reporting")
...
# Chromote headless browser: Massachusetts

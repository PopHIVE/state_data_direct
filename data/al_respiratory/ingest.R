# ingest.R - Alabama (AL) Respiratory Surveillance
# Provider: Alabama Department of Public Health
# Tier 2 | Strategy: chromote
# Run from data/al_respiratory/
...
state_fips  <- "01"
state_name  <- "Alabama"
source_urls <- c("https://www.alabamapublichealth.gov/data/respiratory.html")
...
# Chromote headless browser: Alabama

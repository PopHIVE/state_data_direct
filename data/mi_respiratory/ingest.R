# ingest.R - Michigan (MI) Respiratory Surveillance
# Provider: Michigan Department of Health and Human Services
...
state_fips  <- "26"
state_name  <- "Michigan"
source_urls <- c("https://www.michigan.gov/mdhhs/keep-mi-healthy/infectious-diseases/seasonal-respiratory-viruses/respiratory-disease-reports")
...
# Chromote headless browser: Michigan

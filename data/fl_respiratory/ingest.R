# ingest.R - Florida (FL) Respiratory Surveillance
# Provider: Florida Department of Health
# Tier 2 | Strategy: chromote
# Run from data/fl_respiratory/
...
state_fips  <- "12"
state_name  <- "Florida"
source_urls <- c("https://www.floridahealth.gov/diseases-and-conditions/respiratory-illness/influenza/florida-influenza-surveillance-report-archive/index.html", "https://www.flhealthcharts.gov/ChartsDashboards/rdPage.aspx?rdReport=Covid19.Dataviewer")
...
# Chromote headless browser: Florida

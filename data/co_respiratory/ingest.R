# ingest.R - Colorado (CO) Respiratory Surveillance
# Provider: Colorado Department of Public Health & Environment
# Tier 1 | Strategy: arcgis_direct
# Run from data/co_respiratory/
...
state_fips  <- "08"
state_name  <- "Colorado"
source_urls <- c("https://cdphe.colorado.gov/viral-respiratory-diseases-report")
...
# ArcGIS FeatureServer direct query: Colorado
result <- tryCatch({
  fs_urls <- c("https://services3.arcgis.com/66aUo8zsujfVXRIT/arcgis/rest/services/CDPHE_Viral_Respiratory_Homepage_/FeatureServer/0", "https://services3.arcgis.com/66aUo8zsujfVXRIT/arcgis/rest/services/CDPHE_Viral_Respiratory_Syndromic_Surveillance/FeatureServer/0", "https://services3.arcgis.com/66aUo8zsujfVXRIT/arcgis/rest/services/CDPHE_Viral_Respiratory_Sentinel_Positivity/FeatureServer/0")
  found_data <- FALSE
  data_raw   <- NULL
  all_data   <- list()

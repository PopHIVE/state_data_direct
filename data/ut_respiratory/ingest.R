# ingest.R - Utah (UT) Respiratory Surveillance
# Provider: Utah Department of Health and Human Services
# Tier 2 | Strategy: chromote
# Run from data/ut_respiratory/
...
state_fips  <- "49"
state_name  <- "Utah"
source_urls <- c("https://dhhs.utah.gov/health-dashboards/respiratory-disease-data/")
...
# Chromote headless browser: Utah

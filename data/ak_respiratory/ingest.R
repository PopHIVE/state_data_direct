# ingest.R - Alaska (AK) Respiratory Surveillance
# Provider: Alaska Department of Health
# Tier 2 | Strategy: chromote
# Run from data/ak_respiratory/
...
state_fips  <- "02"
state_name  <- "Alaska"
source_urls <- c("https://health.alaska.gov/en/resources/respiratory-virus-snapshot/")
...
# Chromote headless browser: Alaska

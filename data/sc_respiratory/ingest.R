# ingest.R - South Carolina (SC) Respiratory Surveillance
# Provider: South Carolina Department of Public Health
# Tier 2 | Strategy: chromote
# Run from data/sc_respiratory/
...
source_urls <- c("https://dph.sc.gov/respiratory-disease-dashboard", "https://dph.sc.gov/professionals/public-health-data/flu-watch")
...
# Chromote headless browser: South Carolina

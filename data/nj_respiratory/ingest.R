# ingest.R - New Jersey (NJ) Respiratory Surveillance
# Provider: New Jersey Department of Health
# Tier 2 | Strategy: chromote
# Run from data/nj_respiratory/
...
source_urls <- c("https://www.nj.gov/health/respiratory-viruses/data-and-reports/#respiratory-illness-dashboard")
...
# Chromote headless browser: New Jersey

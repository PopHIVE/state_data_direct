...
source_urls <- c("https://ldh.la.gov/page/respiratory-hospitalization-data", "https://ldh.la.gov/page/respiratory-emergency-department-visits-data", "https://ldh.la.gov/page/respiratory-laboratory-survey-data")
...
# Chromote headless browser: Louisiana

# ingest.R - Iowa (IA) Respiratory Surveillance
# Provider: Iowa Department of Health and Human Services
# Tier 2 | Strategy: chromote
# Run from data/ia_respiratory/
...
state_fips  <- "19"
state_name  <- "Iowa"
source_urls <- c("https://hhs.iowa.gov/health-prevention/providers-professionals/iowa-influenza-surveillance")
...
# Chromote headless browser: Iowa

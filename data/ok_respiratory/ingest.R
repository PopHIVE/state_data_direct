# ingest.R - Oklahoma (OK) Respiratory Surveillance
# Provider: Oklahoma State Department of Health
# Tier 2 | Strategy: chromote
# Run from data/ok_respiratory/
...
state_fips  <- "40"
state_name  <- "Oklahoma"
source_urls <- c("https://oklahoma.gov/health/health-education/acute-disease-service/viral-view/respiratory-data.html", "https://oklahoma.gov/health/health-education/acute-disease-service/viral-view/covid-19.html")
...
# Chromote headless browser: Oklahoma

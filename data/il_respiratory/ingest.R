# ingest.R - Illinois (IL) Respiratory Surveillance
# Provider: Illinois Department of Public Health
# Tier 2 | Strategy: chromote
# Run from data/il_respiratory/
...
state_fips  <- "17"
state_name  <- "Illinois"
source_urls <- c("https://dph.illinois.gov/topics-services/diseases-and-conditions/respiratory-disease/surveillance/respiratory-disease-report.html", "https://public.data.illinois.gov/")
...
# Chromote headless browser: Illinois
